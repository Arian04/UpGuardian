...
class _RequestRowData {
  ...
  _RequestRowData({String endpoint = '', String method = '', String body = '', String oldResponse = '', String newResponse = ''})
...
class _RequestsTablePageState extends State<RequestsTablePage> {
  ...
  Widget _header() => Container(
        ...
        child: Row(children: const [
          Expanded(flex: 2, child: Text('Endpoints', style: TextStyle(fontWeight: FontWeight.bold))),
          SizedBox(width: 12),
          Expanded(flex: 2, child: Text('Methods', style: TextStyle(fontWeight: FontWeight.bold))),
          SizedBox(width: 12),
